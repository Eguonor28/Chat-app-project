...
const MessageContainer = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto scrollbar-hidden p-4 px-8 md:w-[65w] lg:w-[70vw] xl:w-[80vw] w-full">
      ...
      <div ref={scrollRef}>
        {showImage && (
          <div className="fixed inset-0 z-[1000] flex flex-col items-center justify-center backdrop-blur-lg bg-black/50">
            {/* Image container */}
            ...
            <div className="flex gap-5 absolute top-5 right-5">
              <button
                className="bg-black/30 p-3 text-2xl rounded-full hover:bg-black/60 cursor-pointer transition-all duration-300 text-white"
